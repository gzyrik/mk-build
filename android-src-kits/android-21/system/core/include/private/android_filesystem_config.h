...
static const struct android_id_info android_ids[] = {
    ...
    { "misc",          AID_MISC, },
    { "nobody",        AID_NOBODY, },
    { "internal_wr",   AID_INTERNAL_WR, }, /* SPRD: support double sdcard add for storage manager */
    { "external_wr",   AID_EXTERNAL_WR, }, /* SPRD: support double sdcard add for storage manager */
};
