...
public:
    ...
    // Current flash_mode_support.
    static const char KEY_FLASH_MODE_SUPPORTED[];

    //Current performance autotest settings
    //Example value: "true" or "false"
    static const char KEY_PERFORMANCE_AUTOTEST[];
