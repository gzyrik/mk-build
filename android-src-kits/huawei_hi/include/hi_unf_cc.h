...
none. CNcomment: 无。CNend
*/
typedef HI_S32 (*HI_UNF_CC_GETTEXTSIZE_CB_FN)(HI_U32 u32Userdata, HI_U16 *u16Str,HI_S32 s32StrNum, HI_S32 *ps32Width, HI_S32 *ps32Heigth);
...
none. CNcomment: 无。CNend
*/
typedef HI_S32 (*HI_UNF_CC_DISPLAY_CB_FN)(HI_U32 u32Userdata, HI_UNF_CC_DISPLAY_PARAM_S *pstCCdisplayParam);
...
none. CNcomment: 无。CNend
*/
typedef HI_S32 (*HI_UNF_CC_GETPTS_CB_FN)(HI_U32 u32UserData, HI_S64 *ps64CurrentPts);
...
none. CNcomment: 无。CNend
*/
typedef HI_S32 (*HI_UNF_CC_BLIT_CB_FN)(HI_U32 u32UserData, HI_UNF_CC_RECT_S *pstSrcRect, HI_UNF_CC_RECT_S *pstDstRect);
...
none. CNcomment: 无。CNend
*/
typedef HI_S32 (*HI_UNF_CC_VBI_CB_FN)(HI_U32 u32UserData, HI_UNF_CC_VBI_DADA_S *pstVBIData);
...
typedef struct hiUNF_CC_PARAM_S
{
    ...
    HI_U32                       u32UserData;        /**<user data,used in callback function *//**<CNcomment:用户私有数据，用于回调函数 */
} HI_UNF_CC_PARAM_S;
